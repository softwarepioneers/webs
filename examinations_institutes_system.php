...
?>
                    ...
                    <div class="col-xs-12 col-md-12">
                         <form action="" method="post" id="contact-us" class="form">
                            ...
                            <div class="form-group col-sm-4">
                                <input 
                                 type="text" 
                                 name="InstituteWhatsApp" 
                                 id="InstituteWhatsApp" 
                                 autocomplete="off" 
                                 placeholder=" وأتساب المعهد"  
                                 required 
                                 class="form-control custom-form-control input-lg " />
                            </div>
                            ...
                            <div class="form-group col-sm-4">
                                <input 
                                 type="text" 
                                 name="InstituteSpecialty" 
                                 id="InstituteSpecialty" 
                                 autocomplete="off" 
                                 placeholder="تخصص المعهد"  
                                 required 
                                 class="form-control custom-form-control input-lg " />
                            </div>
                            ...
                            <div class="form-group col-sm-4">
                                <input 
                                 type="text" 
                                 name="InstituteSystem" 
                                 id="InstituteSystem" 
                                 autocomplete="off" 
                                 placeholder="إمتحانات  المعهد"  
                                 required 
                                 class="form-control custom-form-control input-lg " />
                            </div>
                            ...
                            <div class="form-group col-sm-4">
                                <input 
                                 type="text" 
                                 name="InstituteSystemType" 
                                 id="InstituteSystemType" 
                                 autocomplete="off" 
                            ...
                            <div class="form-group col-md-12 text-center">
                                <input 
                                type="submit" 
                                name="RegisterExaminationInstituteSystem"
                                value="التسجيل" 
            ...
            <div style="overflow-x: auto;">
                ...
                <table id="example" class="table table-striped table-bordered" style="width: 100%; border: 4px solid white;">
                    <thead>
                        <tr>
                            <th style="width: 3%;">إسم المعهد</th>
                            <th style="width: 3%;">نوع المعهد</th>
                            <th style="width: 3%;">إقليم المعهد</th>
                            <th style="width: 3%;">مدينة المعهد</th>
                            <th style="width: 3%;">إمتحانات  المعهد</th>
