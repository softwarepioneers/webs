...
?>
            ...
            <div class="row">
                <div class="container-fluid">
                        ...
                        <div id="blog-thumbnail hidden-xs hidden-sm" class="thumbnail custom-thumbnail">
                            ...
                            <div class="caption custom-caption">
                                <div class="text-center">
                                    ...
                                    <h6 class="custom-title hidden-sm hidden-md hidden-lg hidden-xl hidden-xxl">المعلمين</h6>
                                    ...
                                    <p><a href="teachers_awdal.php" class="btn btn-primary custom-btn-primary">السجلات </a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-2 col-sm-3 col-xs-6">
                        <div id="blog-thumbnai hidden-xs hidden-sml" class="thumbnail custom-thumbnail">
                            <img src="images/Laptop.png" alt="schools" class="Image-zise" />
                            <br />
                            <div class="caption custom-caption">
                                <div class="text-center">
                                    ...
                                    <p><a href="teachers_maroodijeex.php" class="btn btn-primary custom-btn-primary">السجلات </a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="blog-thumbnail hidden-xs hidden-sm" class="thumbnail custom-thumbnail">
                            ...
                            <div class="caption custom-caption">
                                <div class="text-center">
                                    ...
                                    <p><a href="teachers_saaxil.php" class="btn btn-primary custom-btn-primary">السجلات </a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="blog-thumbnail hidden-xs hidden-sm" class="thumbnail custom-thumbnail">
                            ...
                            <div class="caption custom-caption">
                                <div class="text-center">
                                    ...
                                    <p><a href="teachers_sanaag.php" class="btn btn-primary custom-btn-primary">السجلات </a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="blog-thumbnail hidden-xs hidden-sm" class="thumbnail custom-thumbnail">
                            ...
                            <div class="caption custom-caption">
                                <div class="text-center">
                                    ...
                                    <p><a href="teachers_sool.php" class="btn btn-primary custom-btn-primary">السجلات </a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="blog-thumbnail hidden-xs hidden-sm" class="thumbnail custom-thumbnail">
                            ...
                            <div class="caption custom-caption">
                                <div class="text-center">
                                    ...
                                    <p><a href="teachers_togdheer.php" class="btn btn-primary custom-btn-primary">السجلات </a></p>
                                </div>
                            </div>
                        </div>
                    </div>
