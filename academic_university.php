                        ...
                        <div id="blog-thumbnail hidden-xs hidden-sm" class="thumbnail custom-thumbnail">
                            ...
                            <div class="caption custom-caption">
                                <div class="text-center">
                                    ...
                                    <p><a href="awdal_universities_contract.php" class="btn btn-primary custom-btn-primary">التسجيل </a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="blog-thumbnai hidden-xs hidden-sml" class="thumbnail custom-thumbnail">
                            ...
                            <div class="caption custom-caption">
                                <div class="text-center">
                                    ...
                                    <p><a href="maroodijeex_universities_contract.php" class="btn btn-primary custom-btn-primary">التسجيل </a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="blog-thumbnail hidden-xs hidden-sm" class="thumbnail custom-thumbnail">
                            ...
                            <div class="caption custom-caption">
                                <div class="text-center">
                                    ...
                                    <p><a href="saaxil_universities_contract.php" class="btn btn-primary custom-btn-primary">التسجيل </a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="blog-thumbnail hidden-xs hidden-sm" class="thumbnail custom-thumbnail">
                            ...
                            <div class="caption custom-caption">
                                <div class="text-center">
                                    ...
                                    <p><a href="sanaag_universities_contract.php" class="btn btn-primary custom-btn-primary">التسجيل </a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="blog-thumbnail hidden-xs hidden-sm" class="thumbnail custom-thumbnail">
                            ...
                            <div class="caption custom-caption">
                                <div class="text-center">
                                    ...
                                    <p><a href="sool_universities_contract.php" class="btn btn-primary custom-btn-primary">التسجيل </a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="blog-thumbnail hidden-xs hidden-sm" class="thumbnail custom-thumbnail">
                            ...
                            <div class="caption custom-caption">
                                <div class="text-center">
                                    ...
                                    <p><a href="togdheer_universities_contract.php" class="btn btn-primary custom-btn-primary">التسجيل </a></p>
                                </div>
                            </div>
                        </div>
                    </div>
