<?php
$PageName="الأنظمة المعاهد ";
include 'institutes_hearder.php';
?>
            <br />
            <br />
            <br />
                ...
                <table id="example" class="table table-striped table-bordered" style="width: 100%; border: 4px solid white;">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 3%;">نظام المعهد</th>
