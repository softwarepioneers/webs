<div id="footer" class="row">
                <div class="container-fluid-fluid">
                    ...
                    <div id="footer-nav-links" class="col-xs-12 text-center">
                        ...
                        <a href="dashboard_centers.php" class="hidden-xs hidden-sm">نظام الوزارة  </a>
                        <a href="dashboard_universities.php"  class="hidden-xs hidden-sm">نظام الجامعات  </a>
                        <a href="dashboard_institutes.php"  class="hidden-xs hidden-sm">نظام المعاهد   </a>
                        <a href="dashboard_schools.php"  class="hidden-xs hidden-sm">نظام المدارس   </a>
                        <a href="https://3bkri.com/" target="_blank" class="hidden-xs hidden-sm">نظام الإمتحانات   </a>
