...
?>
                    ...
                    <div class="col-xs-12 col-md-12">
                         <form action="" method="post" id="contact-us" class="form">
                            ...
                            <div class="form-group col-sm-4">
                                <input 
                                 type="text" 
                                 name="UniversityMobile" 
                                 id="UniversityMobile" 
                                 autocomplete="off" 
                                 placeholder=" جوال الجامعة"  
                                 required 
                                 class="form-control custom-form-control input-lg " />
                            </div>
                            ...
                            <div class="form-group col-sm-4">
                                <input 
                                 type="text" 
                                 name="UniversityWhatsApp" 
                                 id="UniversityWhatsApp" 
                                 autocomplete="off" 
                                 placeholder=" وأتساب الجامعة"  
                                 required 
                                 class="form-control custom-form-control input-lg " />
                            </div>
                            ...
                            <div class="form-group col-sm-4">
                                <input 
                                 ...
                                 id="UniversitySpecialty" 
                                 autocomplete="off" 
                                 placeholder="تخصص الجامعة"  
                                 required 
                                 class="form-control custom-form-control input-lg " />
                            </div>
                            ...
                            <div class="form-group col-sm-4">
                                <input 
                                 type="text" 
                                 name="UniversitySystemType" 
                                 id="UniversitySystemType" 
                                 autocomplete="off" 
                                 placeholder="نوع الإمتحانات"  
                                 required 
                                 class="form-control custom-form-control input-lg " />
                            </div>
                            ...
                            <div class="form-group col-md-12 text-center">
                                <input 
                                type="submit" 
                                name="RegisterExaminationUniversitySystem"
                                value="التسجيل" 
            ...
            <div style="overflow-x: auto;">
                ...
                <table id="example" class="table table-striped table-bordered" style="width: 100%; border: 4px solid white;">
                    <thead>
                        <tr>
                            <th style="width: 3%;">إسم الجامعة</th>
                            <th style="width: 3%;">نوع الجامعة</th>
                            <th style="width: 3%;">إقليم الجامعة</th>
                            <th style="width: 3%;">مدينة الجامعة</th>
                            <th style="width: 3%;">إمتحانات الجامعة</th>
                            <th style="width: 3%;">نوع الإمتحانات</th>
                        </tr>
                    </thead>
                 <tbody> 
                        <tr>
