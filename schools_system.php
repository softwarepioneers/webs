<?php
$PageName=" لأنظمة المدارس";
include 'schools_hearder.php';
?>
            <br />
            <br />
            <br />
            ...
            <div style="overflow-x: auto;">
                ...
                <table id="example" class="table table-striped table-bordered" style="width: 100%; border: 4px solid white;">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 3%;">نظام المدرسة</th>
                ...
                while($row = $result->fetch_assoc()){
                    ...
                    <td>$row[SchoolPassword]</td> 
                    <td>$row[SchoolSystem]</td> 
                    <td>$row[SchoolSystemType]</td>
            ...
            var tbl = document.getElementById("example");
                for(var x = 1 ; x < tbl.rows.length; x++){
                       tbl.rows[x].onclick = function(){
                        document.getElementById("SchoolName").value= this.cells[0].innerHTML;
                        document.getElementById("SchoolType").value= this.cells[1].innerHTML;
                        document.getElementById("SchoolRegion").value= this.cells[2].innerHTML;
                        document.getElementById("SchoolCity").value= this.cells[3].innerHTML;
                        document.getElementById("StartContract").value= this.cells[4].innerHTML;
                        document.getElementById("EndContract").value= this.cells[5].innerHTML;
