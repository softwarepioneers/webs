                        ...
                        <div id="blog-thumbnail hidden-xs hidden-sm" class="thumbnail custom-thumbnail">
                            ...
                            <div class="caption custom-caption">
                                <div class="text-center">
                                    ...
                                    <p><a href="awdal_institutes_contracts.php" class="btn btn-primary custom-btn-primary">السجلات </a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="blog-thumbnai hidden-xs hidden-sml" class="thumbnail custom-thumbnail">
                            ...
                            <div class="caption custom-caption">
                                <div class="text-center">
                                    ...
                                    <p><a href="maroodijeex_institutes_contracts.php" class="btn btn-primary custom-btn-primary">السجلات </a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="blog-thumbnail hidden-xs hidden-sm" class="thumbnail custom-thumbnail">
                            ...
                            <div class="caption custom-caption">
                                <div class="text-center">
                                    ...
                                    <p><a href="saaxil_institutes_contracts.php" class="btn btn-primary custom-btn-primary">السجلات </a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="blog-thumbnail hidden-xs hidden-sm" class="thumbnail custom-thumbnail">
                            ...
                            <div class="caption custom-caption">
                                <div class="text-center">
                                    ...
                                    <p><a href="sanaag_institutes_contracts.php" class="btn btn-primary custom-btn-primary">السجلات </a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="blog-thumbnail hidden-xs hidden-sm" class="thumbnail custom-thumbnail">
                            ...
                            <div class="caption custom-caption">
                                <div class="text-center">
                                    ...
                                    <p><a href="sool_institutes_contracts.php" class="btn btn-primary custom-btn-primary">السجلات </a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="blog-thumbnail hidden-xs hidden-sm" class="thumbnail custom-thumbnail">
                            ...
                            <div class="caption custom-caption">
                                <div class="text-center">
                                    ...
                                    <p><a href="togdheer_institutes_contracts.php" class="btn btn-primary custom-btn-primary">السجلات </a></p>
                                </div>
                            </div>
                        </div>
                    </div>
