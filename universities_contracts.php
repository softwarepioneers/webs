                ...
                <div class="container">
                    ...
                    <form action="" method="post" id="contact-us" class="form">
                            ...
                            <div class="form-group col-sm-4">
                                <input 
                                 type="text" 
                                 name="UniversityNeeds" 
                                 id="UniversityNeeds" 
                                 autocomplete="off" 
                                 placeholder=" حاجة الجامعة"  
                                 required 
                                 class="form-control custom-form-control input-lg " />
                            </div>
                            ...
                            <div class="form-group col-md-12 text-center">
                                <input 
                                type="submit" 
                                name="RegisterUniversityContract"
                                value="التسجيل" 
                ...
                <table id="example" class="table table-striped table-bordered" style="width: 100%; border: 4px solid white;">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 3%;">نظام الجامعة</th>
                            <th style="width: 3%;">نوع النظام</th>
                        </tr>
                    </thead>
                 <tbody> 
                        <tr>
