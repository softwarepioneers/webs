                        ...
                        <div id="blog-thumbnail hidden-xs hidden-sm" class="thumbnail custom-thumbnail">
                            ...
                            <div class="caption custom-caption">
                                <div class="text-center">
                                    ...
                                    <p><a href="awdal_centers_contracts.php" class="btn btn-primary custom-btn-primary">السجلات </a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="blog-thumbnai hidden-xs hidden-sml" class="thumbnail custom-thumbnail">
                            ...
                            <div class="caption custom-caption">
                                <div class="text-center">
                                    ...
                                    <p><a href="maroodijeex_centers_contracts.php" class="btn btn-primary custom-btn-primary">السجلات </a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="blog-thumbnail hidden-xs hidden-sm" class="thumbnail custom-thumbnail">
                            ...
                            <div class="caption custom-caption">
                                <div class="text-center">
                                    ...
                                    <p><a href="saaxil_centers_contracts.php" class="btn btn-primary custom-btn-primary">السجلات </a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="blog-thumbnail hidden-xs hidden-sm" class="thumbnail custom-thumbnail">
                            ...
                            <div class="caption custom-caption">
                                <div class="text-center">
                                    ...
                                    <p><a href="sanaag_centers_contracts.php" class="btn btn-primary custom-btn-primary">السجلات </a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="blog-thumbnail hidden-xs hidden-sm" class="thumbnail custom-thumbnail">
                            ...
                            <div class="caption custom-caption">
                                <div class="text-center">
                                    ...
                                    <p><a href="sool_centers_contracts.php" class="btn btn-primary custom-btn-primary">السجلات </a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="blog-thumbnail hidden-xs hidden-sm" class="thumbnail custom-thumbnail">
                            ...
                            <div class="caption custom-caption">
                                <div class="text-center">
                                    ...
                                    <p><a href="togdheer_centers_contracts.php" class="btn btn-primary custom-btn-primary">السجلات </a></p>
                                </div>
                            </div>
                        </div>
                    </div>
