...
?>
                        ...
                        <form action="" method="post" id="contact-us" class="form">
                            ...
                            <div class="form-group col-sm-4">
                                <input 
                                 ...
                                 id="EnterpriseWhatsapp" 
                                 autocomplete="off" 
                                 placeholder=" وأتساب المنشآة"  
                                 required 
                                 class="form-control custom-form-control input-lg " />
                            </div>
                            ...
                            <div class="form-group col-sm-4">
                                <input 
                                 type="text" 
                                 name="EnterpriseDistrict" 
                                 id="EnterpriseDistrict" 
                                 autocomplete="off" 
                                 placeholder="مديرية المنشآة"  
                                 required 
                                 class="form-control custom-form-control input-lg " />
                            </div>
                            ...
                            <div class="form-group col-sm-4">
                                <input 
                                 type="text" 
                                 name="EnterpriseSpecialty" 
                                 id="EnterpriseSpecialty" 
                                 autocomplete="off" 
                                 placeholder="تخصص المنشآة"  
                                 required 
                                 class="form-control custom-form-control input-lg " />
                            </div>
            ...
            <div style="overflow-x: auto;">
                ...
                <table id="example" class="table table-striped table-bordered" style="width: 100%; border: 4px solid white;">
                    <thead>
                        <tr>
                            <th style="width: 3%;">إسم المنشآة</th>
                            <th style="width: 3%;">نوع المنشآة</th>
                            <th style="width: 3%;">إقليم المنشآة</th>
                            <th style="width: 3%;">مدينة المنشآة</th>
                            <th style="width: 3%;">نظام المنشآة</th>
